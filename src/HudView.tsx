...
class HudView extends Component {
  ...
  showSpinner() {
    const icon =
      this.props.spinnerComponent || this._renderDefaultSpinnerComponent();
    return this._showHud(icon, true);
  }

  showSuccess() {
    const icon =
      this.props.successComponent || this._renderDefaultSuccessComponent();
    return this._showHud(icon, false, true);
  }

  showError() {
    const icon =
      this.props.errorComponent || this._renderDefaultErrorComponent();
    return this._showHud(icon, false, true);
  }
