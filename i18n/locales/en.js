export default {
  ...
  later: 'Later',
  risky_ppl_nearby: 'If a COVID-19 positive person was nearby',
  app_can_check_with_bluetooth: 'Doctor Chana can detect with Bluetooth',
  pls_grant_bluetooth_access: 'Please grant Bluetooth access',
  consume_low_energy_and_can_detect_closed_contact:
    'Consume low level of energy to allow scanning people around you and notify you if you were close to a COVID-19 positive person',
  ...
  help_notify_if_you_get_near_risky_person_or_area:
    'To help notify you if you were near a COVID-19 positive person or in a risky area',
  ...
  when_you_are_closed_to_risky_ppl:
    'When you were close to a COVID-19 positive person',
  ...
  no_update_for: 'Has not been updated for ',
  minute_s: 'minute(s)',
  last_update: 'Last Update at',
  hh_mm: 'HH:mm',
  can_not_generate_qr: 'Cannot generate QR code',
  connect_internet_to_generate_qr: 'Connect to the internet to generate QR code',
  try_again: 'Try again',
  qr_expired: 'QR code is expired',
  connect_internet_to_update: 'Connect to the internet to update',
  ...
  may_cause_phone_to_consume_higher_energy:
    'may cause the mobile phone to consume higher energy than usual. ',
  ...
  closed_contact_with_covid19_confirmed_case:
    'You were in close contact with confirmed COVID-19 case (closer than 1 metre longer than 5 min)',
  none_of_history_above: 'None of all above',
  occupation_involving_foreigners:
    'Do you have an occupation that need to be close to Foreigner(s) frequently?',
  yes: 'Yes',
  no: 'No',
  ...
  you_will_be_notified_when_closed_to_risky_ppl:
    'You will be notified when you were close to a COVID-19 positive person',
  ...
  pls_update_latest_version_from: 'Please update to the latest version from',
  ok: 'OK',
