export default {  
  ...
  closed_contact_with_covid19_confirmed_case:'You are in closed contact with confirmed COVID-19 case (closer than 1 metre longer than 5 min)',
  ...
  went_to_risky_zone_quar_14d_observe_if_fever_respiratory_go_see_doc:'Because you travelled from COVID-19 risky area, please quarantine 14 days and observe. If you have fever and respiratory problem, please go to see doctor immediately',
  ...
  maybe_other_disease_2d_not_better_go_see_doc:'Could be other disease. If not get better after 2 days, please go see a doctor',
  ...
  privacy_policy_intro_02:'    This App collects, uses, and discloses personal data (hereinafter referred to as “Processing”) as necessary to protect the vital interests of App users, those in their immediate vicinity, and the public in general. It tracks infection and potential risk and monitors the spread of the COVID-19 virus through information provided by App users.',
  privacy_policy_intro_03:'    Before using the App, we request that you (the user) carefully read this Data Protection Policy and its amendments (hereinafter referred to as the “Policy”), including any terms and agreements referred in the App. You will be legally bound by these terms and agreements if you begin to use this App.',
  privacy_policy_intro_04:'    Upon reading this Policy and clicking the accept button below, you have given consent to the Processing of your personal data in accordance with this Policy. However, please do not use this App if you disagree with this Policy\'s Processing of your personal data.',
  privacy_policy_intro_05:'    If you have questions regarding this Policy, please contact us through the channels mentioned below.',
  privacy_policy_body_01:'1. How does the App help?',
  privacy_policy_body_01_01:'1.1	It Provides self-observation information to determine whether you have entered a potential COVID-19 risk area to protect yourself and those around you.',
  privacy_policy_body_01_02:'1.2	It assists doctors, nurses, and hospital personnel during the patient admission procedure and expedites the medical history interview and patient treatment processes.',   privacy_policy_body_01_03:'1.3	It provides an infection risk alert when it detects a nearby infected person and issues recommendations such as seeking immediate medical attention.',   privacy_policy_body_01_04:'1.4	It provides essential information necessary to screen infected or at-risk persons when visiting crowded areas such as shopping malls, stores, or local markets.',
  privacy_policy_body_02:'2. How do we collect your personal data?',
  privacy_policy_body_02_01:'    We collect your personal data directly from you. The collection commences on the day you use the App and continues throughout the usage period. We will not collect your personal data from other sources. ',
  privacy_policy_body_03:'3. What information do we collect?',
  privacy_policy_body_03_00:'    The information we gather from you is necessary for this App to monitor and prevent the spread of COVID-19. The following information will be collected from you.',
  ...
  privacy_policy_body_08_01:'    To exercise any of the rights mentioned, please contact us through the channel mentioned below. We will act on your request within 30 days from the receiving of notice.',
  ...
  privacy_policy_contact_call_center:'    If you have any problems with the App, please call: 1111 (Government Contact Center: GCC)  ',
